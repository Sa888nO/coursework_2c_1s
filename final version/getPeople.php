...
$result = mysqli_query($connect, "SELECT * FROM PeopleBD WHERE District = '".$_POST["parkingPeople"]."'");

$title = "Парковки рядом с вами";
...
$content ='
    ...
    <a class="btn-back" href="searchPeople.php"></a>
';
